...
<body>
    <div id="app">
        ...
        <section class="banner-block home-banner-block" style="background-image: url({{asset('assets/images/home/home-banner1.png')}})">
            <div class="image1">
                <img src="assets/images/home/left-logo.png" class="img-fluid" />
            </div>
            <div class="image2">
                <img src="assets/images/home/logo2.png" class="img-fluid" />
                <img src="assets/images/home/logo1.png" class="img-fluid" />
            </div>
            <div class="image3">
                <img src="assets/images/home/center.png" class="img-fluid" />
            </div>
            <div class="image4">
                <img src="assets/images/home/star.png" class="img-fluid" />
            </div>

        <!-- <img src="{{asset('assets/images/banner-landing.png')}}" class="img-fluid banner-image" /> -->
            <!-- <span class="banner-block-image">
                <img src="{{ asset('assets/images/banner-landing.jpg') }}" />
            </span> -->
            @yield('content')
        </section>
    </div>
